...
export default function Page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#FEE3E3] p-4"> {/* Changed background to light pink */}
      ...
      <h1 className="text-3xl font-bold mb-4 text-[#333333]">Welcome Back!</h1>
      <p className="mb-6 text-center text-[#555555]">
        Please sign in to continue to your account and track your activities.
      </p>
      <div className="w-full max-w-md">
        <SignIn
          path="/sign-in" // Ensures the path is correct
      ...
      <p className="mt-4 text-center text-sm text-[#777777]">
        ...
        <a href="/sign-up" className="text-[#FF6F91] hover:underline">
          Sign up here
        </a>
      </p>
    </div>
